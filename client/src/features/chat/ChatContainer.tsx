import { ChatOptimisticLoading } from "@/features/chat/components";
...
/**
 * 채팅 컨테이너 컴포넌트
 * - 홈 페이지: ChatOptimisticLoading 표시
  ...
  return (
    <section className="themed-scrollbar flex w-full justify-center overflow-y-auto">
      <div className="flex w-full flex-col px-3 text-base md:max-w-[42rem] xl:max-w-[48rem]">
        {isHome ? <ChatOptimisticLoading /> : <ChatMessageList chatRoomId={chatRoomId} />}
